    ...
    <div class="row">
      ...
      <div class=" col-xl-7 p-0" style="background-color: #f7f7f7;">
        <div class="login-card" style="margin-top:10px ;">
          <div class="">
            <div class="login-main" style="width: 450px; margin-top: -50px">
              <form class="theme-form" method="post" action="<?php echo $base_url; ?>login">
                ...
                <div class="form-group">
                  ...
                  <div class="form-input position-relative">
                    ...
                    <div class="show-hide"><span style="color: #00942A;" class="show"> </span></div>
                  </div>
                </div>
                <div class="form-group mb-0">
                  ...
                  <button class="btn btn-block w-100" style="background-color:#00942A; color:#f7f7f7;" type="submit">Masuk</button>
                </div>
                <p class="mt-4 mb-0 text-center">Belum punya akun ?<a style="color:#00942A;" class="ms-2" href="#" onclick="$('#modal_register').modal('show');" data-toggle="modal" data-target="#modal_register">Buat Akun</a></p>
              </form>
              <form id="login"></form>
            </div>
          </div>
        </div>
        <img style="margin-top: -120px;" src="<?php echo $base_url; ?>cuba/assets/images/silluet.png" alt="">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn" style="background-color:#00942A; color:#f7f7f7;" onclick=" sendData('#register_form','account/register');">Register</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
