...
<div class="card">
	<div class="card-header">
		...
		<div class="card-options ">
			...
			<a href="#" title="Refresh Pengaduan" onclick="refresh_pengaduan();"><i class="fe fe-refresh-cw"></i></a>
...
function dt(){
    $(document).ready(function() {
        $('#mytbl').DataTable( {
            "ajax": '<?php echo base_url()?>api_indicar/dt_pengaduan'
        } );
    });
}
...
function refresh_pengaduan(){
    ...
    $.ajax({
        url: "<?php echo base_url()?>api_indicar/refresh_pengaduan",
        type: "post",
        success: function (response) {
            swal("Update!", "Berhasil mengupdate data pengaduan", "success");
        },
        error: function(jqXHR, textStatus, errorThrown) {
           console.log(textStatus, errorThrown);
        }
