...
$cols.="tglwal,obj,nama,jam,lokasi,lat,lng,giat,ambang,kategori";
?>
<input type="hidden" name="path" value="rengiat_wal">

<input type="hidden" name="tablename" value="rengiat_wal">
...
<div class="row">
	<div class="col-sm-6 col-md-3">
		<div class="form-group">
			...
			<input type="text" id="tglwal" name="tglwal" class="form-control datepicker" placeholder="" >
		</div>
	</div>
...
<?php }?>
	...
	<div class="col-sm-6 col-md-4">
		<div class="form-group">
			<label class="form-label">Kategori Pengawalan</label>
...
<div class="row">
	<div class="col-sm-6 col-md-4">
		<div class="form-group">
			...
			<input type="text" id="giat" name="giat" class="form-control" placeholder="" >
		</div>
	</div>
	<div class="col-sm-6 col-md-4">
		<div class="form-group">
			<label class="form-label">Ambang Gangguan</label>
			<select name="ambang" class="form-select" placeholder="">
				<option value=""></option>
<?php for($i=0;$i<count($ambang);$i++){?>
<option value="<?php echo $ambang[$i]['val']?>"><?php echo $ambang[$i]['txt']?></option>
<?php }?>
			</select>
		</div>
	</div>
