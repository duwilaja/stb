		...
		<!--form id="myf" class="form-horizontal"-->		
		  <div class="row">
			<div class="form-group col-md-12">
				...
				<input type="hidden" name="jenis" value="" id="jenis">
				<select id="jenis_id" name="jenis_id" class="form-control select2" placeholder="" onchange="$('#jenis').val(this.options[this.selectedIndex].text);">
				<?php foreach($jj as $j){?>
