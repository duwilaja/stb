...
<body>
        ...
        <div class="page-header">
            <div class="header-wrapper row m-0">
                    ...
                    <div class="form-group w-100">
                        <div class="Typeahead Typeahead--twitterUsers">
                            <div class="u-posRelative">
                                <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text" placeholder="Cari .." name="q" title="" autofocus>
                ...
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?php echo $base_url; ?>cuba/assets/images/logo/logo.png" alt=""></a></div>
                ...
                <div class="nav-right col-8 pull-right right-header p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown p-0 me-0">
                            <div class="media profile-media"><img class="b-r-10" src="<?php echo $avatar ?>" alt="" style="width:37px;height:37px;">
                        ...
                        <?php if ($session['wasdal'] == 'N') { ?>
                            <div id="sidebar-menu usr">
                                <ul class="sidebar-links" id="simple-bar">
                                    <li class="back-btn"><a href="<?php echo $base_url; ?>home"><img class="img-fluid" src="<?php echo $base_url; ?>cuba/assets/images/logo/logo-icon.png" alt=""></a>
                            ...
                            <div id="sidebar-menu wasdal">
                                <ul class="sidebar-links" id="simple-bar">
                                    ...
                                    if (isset($units)) {
                                        foreach ($units as $u) {
                                    ?>
                                            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="server"></i><span><?php echo $u['unit_nam'] ?></span>
                                                    <div class="according-menu"><i class="fa fa-angle-right"></i></div>
                                                </a>
                                                <ul class="sidebar-submenu" style="display: none;">
                                                    <?php
    ...
    <script>
        ...
        function ambil_isi(v, p, t, cek) {
            ...
            <?php if ($this->uri->segment(2) == 'view_upd') { ?>
                get_content(p + '/get_content?col=<?= $this->input->get('col'); ?>&t=<?= $this->input->get('t'); ?>&rowid=<?= $this->input->get('rowid'); ?>', {
                    id: v
                }, '.ldr', '#isilaporan');
            <?php } else { ?>
