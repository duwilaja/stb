...
<input type="hidden" name="cols" value="thn,da,jml" />
<input type="hidden" name="tname" value="data_penduduk" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Prop</label>
				<select id="da" name="da" placeholder="..." class="form-control">
...
$tname="data_penduduk d left join polda p on d.da=p.da_id";
$cols="thn,concat(da,'-',da_nam) as dada,jml,d.rowid";
$csrc="da_nam,thn";
