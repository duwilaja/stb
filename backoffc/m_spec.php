...
$page_title="Spesialisasi";
$modal_title="Spesialisasi";
...
<input type="hidden" name="cols" value="spec_id,spec_nam" />
<input type="hidden" name="tname" value="spesialisasi" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="spec_id" name="spec_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="spec_nam" name="spec_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
...
$tname="spesialisasi";
$cols="spec_id,spec_nam,rowid";
$csrc="spec_id,spec_nam";
