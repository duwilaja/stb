...
<input type="hidden" name="cols" value="da_id,da_nam" />
<input type="hidden" name="tname" value="polda" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="da_id" name="da_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
