...
$page_title="Detil Penyebab Macet";
$modal_title="Detil Penyebab Macet";
$card_title="Master $page_title";

$menu="pmacetd";

$breadcrumb="Master/TMC/$page_title";
...
include "inc.db.php";
$conn=connect();
$sebabs=fetch_all(exec_qry($conn,"select sebab,sebab from penyebab_macet order by sebab"));
disconnect($conn);
?>
...
<input type="hidden" name="cols" value="sebab" />
<input type="hidden" name="tname" value="penyebab_macet" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Sebab</label>
				<!--input type="text" id="sebab" name="sebab" placeholder="..." class="form-control"-->
				<select id="sebab" name="sebab" class="form-control">
				<?php echo options($sebabs)?>
				</select>
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Detil</label>
				<input type="text" id="detil" name="detil" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
...
$tname="penyebab_macet_d";
$cols="sebab,detil,rowid";
$csrc="sebab,detil";
