...
$page_title="Kepangkatan";
$modal_title="Kepangkatan";
...
<input type="hidden" name="cols" value="pang_id,pang_nam" />
<input type="hidden" name="tname" value="pangkat" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="pang_id" name="pang_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="pang_nam" name="pang_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
...
$tname="pangkat";
$cols="pang_id,pang_nam,rowid";
$csrc="pang_id,pang_nam";
