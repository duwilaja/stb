...
<input type="hidden" name="cols" value="unit,grp,nama_laporan,view_laporan,isactive,tipe,view_field,icon" />
...
$tname="formulir";
$cols="unit,grp,icon,nama_laporan,view_laporan,isactive,tipe,rowid";
