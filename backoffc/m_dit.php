...
<input type="hidden" name="cols" value="din_id,din_nam" />
<input type="hidden" name="tname" value="dinas" />
		
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="din_id" name="din_id" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Nama</label>
				<input type="text" id="din_nam" name="din_nam" placeholder="..." class="form-control">
			</div>
		  </div>
		</form>
	  </div>
