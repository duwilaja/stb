...
while($row = fetch_row($result)){
	...
	if($x=='didik'){
		$row[$col-2]='<a class="btn btn-sm btn-info" href="JavaScript:;" data-fancybox data-type="iframe" data-src="didik/'.$row[$col-2].'"><i class="fa fa-info-circle"></i> Details</a>';
		$row[0]='<a href="#" class="dttbl"  title="Open" data-toggle="modal" data-target="#didik" onclick="openForm(\''.$x.'\',\''.$row[$col-1].'\',\'#fdidik\',\'#drowid\');">'.$row[0].'&nbsp;</a>';
	}
	if($x=='sertif'){
		$row[$col-2]='<a class="btn btn-sm btn-info" href="JavaScript:;" data-fancybox data-type="iframe" data-src="sertif/'.$row[$col-2].'"><i class="fa fa-info-circle"></i> Details</a>';
		$row[0]='<a href="#" class="dttbl"  title="Open" data-toggle="modal" data-target="#sertif" onclick="openForm(\''.$x.'\',\''.$row[$col-1].'\',\'#fsertif\',\'#srowid\');">'.$row[0].'&nbsp;</a>';
	}
